...
--
-- Host: localhost
-- Generation Time: 2018-09-18 10:01:45
-- 服务器版本： 5.7.18
-- PHP Version: 5.6.30
...
) ENGINE=MyISAM AUTO_INCREMENT=173 DEFAULT CHARSET=utf8 COMMENT='文章表';
...
(172, '草稿演示', '仁贾_陆', '', '<p><strong>这是草稿演示</strong></p>\n', '**这是草稿演示**', 1, '', 1536636269, 1546275661, '客户端测试', 0, 0),
...
CREATE TABLE IF NOT EXISTS `hos_comment` (
  ...
  KEY `from_id` (`from_id`),
  KEY `to_id` (`to_id`)
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=gbk COMMENT='评论表';
...
(1, 'root', 'admin', '4bf994a5467822ec39b76b92c02e792a33c4562a', 22, 1, 'https://upload-images.jianshu.io/upload_images/13417663-ba3041d5bd8209cf.png', 'f5c828ff122cd8d0509051584236cceb28c78bfa', '71424@qq.com', 1531198885, '610000,610100,610102'),
...
(57, 'Greaka1', 'Greak Neir', '4bf994a5467822ec39b76b92c02e792a33c4562a', 0, NULL, '//www.yangzq.top/img/fuck_face.jpg', NULL, NULL, 0, NULL),
(58, 'aa', NULL, 'b4ec5cb6c6167213f83aa95fb0a4524dfccf8b02', 0, NULL, '//dushizz.top/img/default.jpg', '6259f909af3e9a4c4cf1f5402f5870df4e0ce349', NULL, 1531298885, NULL),
(59, 'root2', 'test', '42aeb7a76eb650dc1f13a27c5ab8199446e68d75', 2, NULL, 'https://upload-images.jianshu.io/upload_images/13417663-ba3041d5bd8209cf.png', '57f3ba1c424995ac41d84c8d239963d7da368e75', NULL, 1531299068, NULL),
